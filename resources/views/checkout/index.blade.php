                ...
                <section aria-labelledby="summary-heading" class="bg-tertiary-800 py-12 text-indigo-300 md:px-10 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:w-full lg:max-w-lg lg:bg-transparent lg:px-0 lg:pb-24 lg:pt-0">
                    ...
                    <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                        ...
                        <dl class="space-y-6 border-t border-white border-opacity-10 pt-6 text-sm font-medium">
                            ...
                            <x-checkout.summary-item title="Sub total" value="570,00"/>
                    ...
                    <form>
                        <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                            <div>
                                ...
                                <div class="mt-6">
                                    <x-input-label for="email-address">Email address</x-input-label>
                                    <div class="mt-1">
                                        <x-text-input type="email" id="email-address" name="email-address" autocomplete="email" placeholder="Digite seu e-mail"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-10">
                                ...
                                <div class="mt-6 grid grid-cols-3 gap-x-4 gap-y-6 sm:grid-cols-4">
                                    <div class="col-span-3 sm:col-span-4">
                                        <x-input-label for="card-number">Numero do cartão</x-input-label>
                                        <div class="mt-1">
                                            <x-text-input type="text" id="card-number" name="card-number" autocomplete="cc-number" placeholder="Numero do Cartão"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-2 sm:col-span-3">
                                        ...
                                        <div class="mt-1">
                                            <x-text-input type="text" name="expiration-date" id="expiration-date" autocomplete="cc-exp" placeholder="MM / AA"/>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <x-text-input type="text" name="cvc" id="cvc" autocomplete="cvc" placeholder="CVC"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
